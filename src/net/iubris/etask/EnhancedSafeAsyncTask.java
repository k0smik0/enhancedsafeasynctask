 ...
 * 
 * AbstractEnhancedSafeAsyncTask.java is part of 'Enhancedsafeasynctask'.
 * 
 ...
 * you would handle. <br/>
 * So, don't declare onException(Exception e) and then use some internal logic
 * in order to know exception type, you can declare:
 * <pre>
 ...
 * </pre>
 * For details about original SafeAsyncTask: <a href="http://code.google.com/p/roboguice/source/browse/roboguice/src/main/java/roboguice/util/SafeAsyncTask.java">SafeAsyncTask.java</a>  
 * <br/><br/><br/><br/>
 * 
 * From originalSafeAsyncTask doc:<br/>
 * 
...
public abstract class EnhancedSafeAsyncTask<ResultT> implements Callable<ResultT> {
    ...
    public static class Task<ResultT> implements Callable<Void> {
            ...
            postToUiThreadAndWait( new Callable<Void>() {
            	public Void call() throws Exception {
                    if( e instanceof InterruptedException || e instanceof InterruptedIOException )
                    	...
                    	Method bestMatchedMethod = findBestMatch(e);
        ...
        /**
         * inspired by http://code.google.com/p/asyncwork 
         * @param throwable
         * @return {@link Method}
         */
