 ...
 * 
 * RoboEnhancedAsyncTask_robocapable.java is part of 'EnhancedSafeAsyncTask'.
 * 
...
public abstract class RoboEnhancedAsyncTask_robocapable<ResultT> extends EnhancedSafeAsyncTaskContexted<ResultT> {	
	
	
	protected RoboEnhancedAsyncTask_robocapable(Context context) {
        super(context);
        RoboGuice.getInjector(context).injectMembers(this);
    }

    protected RoboEnhancedAsyncTask_robocapable(Context context, Handler handler) {
        super(context,handler);
        RoboGuice.getInjector(context).injectMembers(this);
    }

    protected RoboEnhancedAsyncTask_robocapable(Context context, Handler handler, Executor executor) {
        super(context,handler, executor);
        RoboGuice.getInjector(context).injectMembers(this);
    }

    protected RoboEnhancedAsyncTask_robocapable(Context context, Executor executor) {
